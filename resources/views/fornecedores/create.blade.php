...
<div class="py-6">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            ...
            <h1 class="text-2xl font-semibold text-gray-800 mb-6">Adicionar Fornecedor</h1>
            ...
            <form action="{{ route('fornecedores.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="telefone" name="telefone" minlength="10" maxlength="11" placeholder="(00) 00000-0000" required
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
                <div>
